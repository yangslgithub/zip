...
(function($) {
		...
		display: function(hide) {
			...
			if ((this.opts.slide && this.pos.arrow || this.opts.fade) && (hide && this.opts.hideAniDuration || !hide && this.opts.showAniDuration)) {
				...
				if (this.opts.slide && this.pos.arrow) {
					var prop, arr;
					if (this.pos.arrow == 'bottom' || this.pos.arrow == 'top' || this.pos.arrow == 'center-bottom' || this.pos.arrow == 'center-top') {
						prop = 'top';
						arr = 'bottom';
					} else {
						prop = 'left';
			...
			switch (this.opts.alignY) {
				...
				case 'inner-top':
					...
					if (!pos.arrow || this.opts.alignTo == 'cursor')
							pos.arrow = elm.w < this.tipOuterW ? 'center-top' : 'top';
					if (this.opts.keepInViewport && pos.t + this.tipOuterH > win.t + win.h) {
						pos.t = yT - this.tipOuterH - this.opts.offsetY;
						if (pos.arrow == 'top' || pos.arrow == 'center-top')
							pos.arrow = elm.w < this.tipOuterW ? 'center-bottom' : 'bottom';
					}
					break;
				case 'center':
				...
				default: // 'top' || 'inner-bottom'
					...
					if (this.opts.keepInViewport && pos.t < win.t) {
						pos.t = yB + this.opts.offsetY;
						if (pos.arrow == 'bottom' || pos.arrow =='center-bottom')
							pos.arrow = elm.w < this.tipOuterW ? 'center-top' : 'top';
					}
			}
			this.pos = pos;
	...
	$.fn.poshytip.defaults = {
		...
		className:		'tip-common',	// class for the tips
